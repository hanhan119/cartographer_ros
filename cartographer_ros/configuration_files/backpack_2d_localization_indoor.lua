...
options = {
  ...
  --publish_tracked_pose_msg = true, --启用将跟踪的姿势发布为geometry_msgs / PoseStamped到主题“ tracked_pose”。
...
POSE_GRAPH.optimize_every_n_nodes = 20   --禁用全局SLAM并专注于LocalSLAM行为的便捷方法。这通常是调整Cartographer的第一件事。
